...
Route::get('/inscreva', 'UsersController@inscreva');
...
Route::get('users/cadastrar', 'UsersController@mostrarFormCadastrarCliente');
Route::post('users/cadastrar', 'UsersController@cadastrarCliente');
