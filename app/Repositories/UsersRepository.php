...
class UsersRepository implements UsersRepositoryInterface {
    ...
    public function buscar($criterios) {
        $buscarPorEmail = filtroFornecido($criterios, 'email');
        $buscarPorCpf = filtroFornecido($criterios, 'cpf', 11);
        $buscarPorSexo = isset($criterios['sexo']);
        $buscarPorTelefone = filtroFornecido($criterios, 'telefone');
        $buscarPorNome = filtroFornecido($criterios, 'nome_sobrenome');
