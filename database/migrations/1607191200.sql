...
CREATE TABLE `itens_venda` (
  ...
  `valor` float NOT NULL DEFAULT '15',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2016-07-19 11:57:59
