...
CREATE TABLE `compras` (
  ...
  CONSTRAINT `fk_bandeira_compra` FOREIGN KEY (`bandeira_cartao_id`) REFERENCES `bandeira_cartao` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO `compras` VALUES (16,'2016-10-05 21:26:23',2,1,90,18,2,2,'5004DC','2016-10-05 21:26:23','2016-10-05 21:26:23');
...
INSERT INTO `db_info` VALUES (1,'1608091813','2016-08-09 21:13:54'),(2,'1608121030','2016-08-12 13:30:00'),(3,'1610041842','2016-10-04 21:42:44'),(4,'1610051828','2016-10-05 21:28:36');
...
CREATE TABLE `forma_pagamento` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `pede_bandeira_cartao` char(1) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `descricao_UNIQUE` (`descricao`)
...
INSERT INTO `forma_pagamento` VALUES (1,'DINHEIRO','2016-08-12 13:22:43','2016-08-12 13:22:43','0'),(2,'CARTÃO DE DÉBITO','2016-08-12 13:22:43','2016-08-12 13:22:43','1'),(3,'CARTÃO DE CRÉDITO','2016-08-12 13:22:43','2016-08-12 13:22:43','1'),(4,'TRANSFERÊNCIA BANCÁRIA','2016-08-12 13:22:43','2016-08-12 13:22:43','0'),(5,'CHEQUE','2016-08-12 13:22:43','2016-08-12 13:22:43','0');
...
INSERT INTO `item_compra` VALUES (5,1300,16,2,15,'2016-10-05 21:26:23','2016-10-05 21:26:23'),(6,1301,16,2,15,'2016-10-05 21:26:23','2016-10-05 21:26:23'),(7,2403,16,1,15,'2016-10-05 21:26:23','2016-10-05 21:26:23'),(8,2409,16,1,15,'2016-10-05 21:26:23','2016-10-05 21:26:23');
...
-- Dump completed on 2016-10-05 18:29:09
