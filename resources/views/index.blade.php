...
<div id="index-banner" class="parallax-container">
    ...
    <div class="parallax"><img src="{{ asset('img/index/background1.jpg') }}" alt="Unsplashed background img 1"></div>
</div>
...
<div class="parallax-container valign-wrapper">
    ...
    <div class="parallax"><img src="{{ asset('img/index/background2.jpg') }}" alt="Unsplashed background img 2"></div>
</div>
...
<div class="parallax-container valign-wrapper">
    ...
    <div class="parallax"><img src="{{ asset('img/index/background3.jpg') }}" alt="Unsplashed background img 3"></div>
</div>
